...
# For each couple, get the corresponding rows in sesA and sesB, flip a coin to decide what is the order of percentage change normalization
...
series_id_df.to_pickle(os.path.join(config.classification_resource_dir, "pairwise_sessions_series_id_df.pkl"))
...
labels_df.to_pickle(os.path.join(config.classification_resource_dir, "pairwise_sessions_labels_df.pkl"))
...
features_df.to_pickle(os.path.join(config.classification_resource_dir, "pairwise_sessions_features_df.pkl"))
